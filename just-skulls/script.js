...
function notification() {
    ...
    if (isMobile) {
        ...
        alert("Данная страница не предназначена для просмотра с мобильного устройства!")
    }
}
...
function stop(event) {
    ...
    if (key == "ArrowRight") {
        ...
        block.src = "character/stands.gif";
        block.name = "stands";
        ...
        block.src = "character/stands_back.gif";
...
function hp_loss() {
    ...
    if (count_losses == 3) {
        document.getElementById("hp_text").innerHTML = "Поражение!";
...
function finish() {
    ...
    if ((block.style.marginLeft == "600px") && (block.style.marginTop == "330px")) {
        ...
        document.getElementById("hp_text").innerHTML = "Победа!";
        setTimeout(reload_page, 2000);
    }
}
